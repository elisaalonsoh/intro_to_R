...
<br><br><br><br><br><br>
<center>presentation of the course</center>
...
`r countdown(minutes = 3, top = 0, right = 0)`
...
`r countdown(minutes = 6, top = 0, right = 0)`
...
<ul>
  <li>All the functions of the dplyr grammar are gatherd in the <b>dplyr package</b></li>
  <ul>
    <li>We can download these functions and make it ready to use with the install.packages() function</li>
  </ul>
</ul>
...
```{r, eval = F}
install.packages("dplyr") # Requires and internet connection
```
