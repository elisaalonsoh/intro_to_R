...
`r countdown(minutes = 3, top = 0, right = 0, play_sound = F, color_border = "#DFE6EB", color_text = "#DFE6EB", color_running_background = "#DFE6EB", color_running_text = "#014D64", color_finished_background = "#014D64", color_finished_text = "#DFE6EB")`
...
<ul>
  <li>You can <b>download</b> this dataset here or from the course webpage</li>
  <ul>
 ...
 * The **first 10 values** of each variable
...
`r countdown(minutes = 6, top = 0, right = 0, play_sound = F, color_border = "#DFE6EB", color_text = "#DFE6EB", color_running_background = "#DFE6EB", color_running_text = "#014D64", color_finished_background = "#014D64", color_finished_text = "#DFE6EB")`
 ...
 * The `dplyr` pakcage is now <b>on your computer</b>, but it is <b>not loaded in R</b>
...
<ul>
  ...
  <ul>
    ...
    <li>and compute <b>statistics for each category</b></li>
  </ul>
</ul>
...
<ul>
  <li><b>mutate()</b> takes a operation that converts:</li>
  <ul>
    <li><b>A vector into another vector</b></li>
  </ul>
  <li><b>summarise()</b> takes a operation that converts:</li>
  <ul>
...
#### 2) Use the `separate()` function from `dplyr` to split the `Score` variable into `home_score` and `away_score`
