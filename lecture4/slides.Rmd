...
```{r, eval = F}
read.csv("slides_elements/data/ligue1.csv") 
                                                    #
                                                    #
                                                    #
                                                    #
...
ggplot(read.csv("slides_elements/data/wid.csv"))                                         # Data
                                                                    #
```
...
```{r, eval = F, fig.width = 8, fig.height = 4.5, out.width = "60%"}
ggplot(read.csv("slides_elements/data/wid.csv"), aes(x = inc_head, y = top1))            # Data & aesthetics
                                                                    #
```
...
starbucks <- read.csv("slides_elements/data/starbucks.csv", sep = ";") # Load data
```
...
```{r}
ggcurve <- read.csv("slides_elements/data/ggcurve.csv")
str(ggcurve)
```
