...
```{r, eval = F}
rio::import(here::here("slides_elements","data", "ligue1.csv"))
                                                    #
                                                    #
                                                    #
                                                    #
...
ggplot(rio::import(here::here("slides_elements","data", "wid.csv")))                                         # Data
                                                                    #
```
...
```{r, eval = F, fig.width = 8, fig.height = 4.5, out.width = "60%"}
ggplot(rio::import(here::here("slides_elements","data", "wid.csv")), aes(x = inc_head, y = top1))            # Data & aesthetics
                                                                    #
```
...
starbucks <- rio::import(here::here("slides_elements","data", "starbucks.csv")) # Load data
```
...
```{r}
ggcurve <- rio::import(here::here("slides_elements","data", "ggcurve.csv"))
str(ggcurve)
```
...
```{r}
asec <- read.csv("slides_elements/data/asec.csv")
str(asec)
```
