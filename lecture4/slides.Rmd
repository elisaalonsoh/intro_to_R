...
petal_lm_surface <- reshape2::acast(petal_lm_surface, Male ~ Hours, value.var = "lEarnings") #y ~ x

plotly::plot_ly(asec_plotly, x = ~Hours, y = ~Male, z = ~lEarnings) %>% 
  plotly::add_markers(size = 5, opacity = .2, color = ~color, colors = c("#6794A7", "#00A2D9"), showlegend=F) %>%
  plotly::add_trace(z = petal_lm_surface,
            x = axis_x,
            y = axis_y,
            type = "surface", 
            colorscale ='YlGnBu',
            opacity = .4) %>% 
  plotly::layout(plot_bgcolor = "#DFE6EB", paper_bgcolor = "#DFE6EB", fig_bgcolor = "#DFE6EB",
...
<ul>
  <li>The <b>huxreg()</b> function from <b>huxtable</b> allows to create such tables.</li>
  <ul>
    <li></li>
    <li></li>
    <li></li>
...
<ul>
  <li>The <b>huxreg()</b> function from <b>huxtable</b> allows to create such tables. Main arguments include:</li>
  <ul>
...
<center><img src = "slides_elements/figures/latex_output.png" width = "900"/></center>
...
<center><img src = "slides_elements/figures/html_output.png" width = "900"/></center>
...
.pull-right[
<center><img src = "slides_elements/figures/docx_output.png" width = "600"/></center>
]
