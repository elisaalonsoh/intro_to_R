---
title: 'Introduction to <img src = "rstudio_logo.png" width = "40"> Programming'
author: "PSE - M1 APE"
date: "Louis Sirugue"
output: 
  html_document:
...
writeLines(paste0('<div class = "share-box" style ="margin-top:-11em;margin-left: auto; margin-right: 3em;"><a href = "https://louissirugue.github.io/metrics_on_R/home', ifelse(dark_theme, "", "_dark"), '.html"><p style = "margin-left:-.51cm;margin-top:-.51cm;width:40px"> <img src = "', astre, '.png"> </p> </a></div>'), 'astre.html')
      ...
      bind_rows(lecture %>%
                  ...
                  mutate(bullet = ifelse(type == "Section" & n > 1, "detail", "item"),
                         link = paste0(root, "lecture", i, "/slides", 
                                       ifelse(dark_theme, "_dark", ""), ".html#", slide),
