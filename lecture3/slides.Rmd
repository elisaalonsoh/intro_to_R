...
<ul>
  <li>Today we're going to use the <a href = "https://www.insee.fr/fr/statistiques/2540004?sommaire=4767262"><b><i>"Fichier des prénom"</i></b></a></li>
  <ul>
...
#### 4) Plot the evolution of the number of birth over time using a line geometry
...
`r countdown(minutes = 15, bottom = 1, left = 0, style = "margin-left:5.65cm;")`
...
<ul>
  ...
  <ul>
    <li>Coutry/state-specific reports</li>
...
<ul>
  <li>To <b>avoid copy-pasting</b> that command for each name we want a report on, we must <b>use a loop</b></li>
</ul>
