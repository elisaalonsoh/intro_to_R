...
```{r, echo = F}
names <- read.csv("slides_elements/data/fichier_prenoms.csv", sep = ";", encoding = "UTF-8")
str(names)
```
...
.pull-left[
<img src = "slides_elements/figures/new_markdown.png" width = "450"/>
]
...
.right-column[
<center><img src = "slides_elements/figures/template.png" width = "650"/></center>
]
...
.pull-left[
  ...
  <center><img src = "slides_elements/figures/inline.png" width = "200"/></center>
 ...
 * To **render** an R Markdown file, click on the **knit button** <img src = "slides_elements/figures/knit.png" width = "35"/> (`ctrl + shift + k`)
 
--

<center><img src = "slides_elements/figures/comparison_1.png" width = "900"/></center>
...
<center><img src = "slides_elements/figures/comparison_2.png" width = "900"/></center>
...
<center><img src = "slides_elements/figures/report_example_1.png" width = "740"/></center>
...
<center><img src = "slides_elements/figures/report_example_2.png" width = "740"/></center>
...
<center><img src = "slides_elements/figures/report_example_3.png" width = "700"/></center>
...
<img src = "slides_elements/figures/default_cosmo.png" width = "550"/></center>
]
...
<img src = "slides_elements/figures/default_cerulean.png" width = "550"/></center>
]
...
<img src = "slides_elements/figures/prettydoc_cayman.png" width = "375"/></center>
]
...
<img src = "slides_elements/figures/prettydoc_tactile.png" width = "360"/></center>
]
...
<img src = "slides_elements/figures/prettydoc_leonids.png" width = "725"/></center>
...
<img src = "slides_elements/figures/rmdformats_downcute.png" width = "550"/></center>
]
...
<img src = "slides_elements/figures/rmdformats_downcute_chaos.png" width = "550"/></center>
]
...
<img src = "slides_elements/figures/rmdformats_readthedown.png" width = "550"/></center>
]
...
<img src = "slides_elements/figures/rmdformats_robobook.png" width = "550"/></center>
]
...
`r ''````{r}
names <- read.csv("slides_elements/data/fichier_prenoms.csv", encoding = "UTF-8", sep = ";") %>%
  mutate(sexe = ifelse(sexe == 1, "Male", "Female")) %>%
  rename(Sex = sexe, Year = annais) %>%
  filter(Year != "XXXX") %>%
  mutate(Year = as.numeric(Year))
