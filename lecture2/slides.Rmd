...
```{r, eval = F}
fb <- rio::import(here::here("lecture2", "ligue1.csv"))
```

```{r, echo = F}
fb <- rio::import(here::here("lecture2", "slides_elements", "data", "ligue1.csv"))
```
...
```{r, eval = F}
starbucks <- rio::import(here::here("lecture2", "starbucks.csv"))
View(starbucks)
```

```{r, echo = F}
starbucks <- rio::import(here::here("lecture2", "slides_elements", "data", "starbucks.csv"))
```
...
```{r, eval = F}
wid <- rio::import(here::here("lecture2", "slides_elements", "data", "wid.csv"))
```
...
```{r, eval = F}
ggsave(here::here("lecture2", "slides_elements", "figures", "wid.png"))
```
...
```{r, eval = F}
ggsave(here::here("lecture2", "slides_elements", "figures", "wid.png"), plot = last_plot(), width = 16, height = 9, unit = "cm", dpi = 900)
```
...
<ul>
  ...
  <ul>
    <li>Similarly you can tune the <b>bandwidth</b> with the <b>bw</b> argument </li>
  </ul>
</ul>
...
trump <- rio::import(here::here("lecture2", "slides_elements", "data", "data-atVjV.csv")) %>%
